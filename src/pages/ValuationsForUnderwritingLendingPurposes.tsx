...
const ValuationsForUnderwritingLendingPurposes = () => {
  const currentSlug = "valuations-for-underwriting-lending-purposes";
  const title = "Valuations for Underwriting/Lending Purposes";
            ...
            <div className="lg:col-span-2 order-1 lg:order-2">
              ...
              >
                ...
                <div className="rounded-2xl overflow-hidden mb-8">
                  <img
                    src="/assets/services_content/valuations-for-underwriting-lending-purposes/valuations-img.jpg"
                    alt={title}
                ...
                <p className="mb-4">
                  Anchor works with many regional and local banks by supplying
                  abbreviated valuations to ensure that the lender is lending at
                  rates and amounts that can be supported by the subject
                  company’s operational cash flow. In addition, banks will
                  recommend our services directly to sellers and buyers to
                  obtain a valuation that the bank feels comfortable with to
                  ensure that underwriting is accurately secured, and that the
                ...
                <p className="mb-4">
                  ...
                  and will review the valuation specifics including, but not
                  limited to, future growth percentages and discount/cap rates
                  (such as rates of return for the subject company).
                </p>
...
export default ValuationsForUnderwritingLendingPurposes;
